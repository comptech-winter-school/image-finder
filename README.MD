...
* Faiss — library of algorithms for finding nearest neighbors in linear space. [](https://github.com/facebookresearch/faiss)
* nmslib — cross-platform similarity search library. [](https://github.com/nmslib/nmslib)
